...
public class GUI implements ActionListener{
    ...
    /* Format Menu */
    JMenuItem iWrap, iFontArial , iFontCSMS , iFontTNR , iFontCSL, iFontSize8, iFontSize12 , iFontSize16 , iFontSize20 , iFontSize24 , iFontSize28, iFontSize30, iFontSize32;
    ...
    public void createFormatMenu(){
        ...
        iFontCSL = new JMenuItem("Consolas");
        iFontTNR.addActionListener(this);
        iFontTNR.setActionCommand("Consolas");
        menuFont.add(iFontCSL);
    ...
    public void createColourMenu(){
        ...
        iCol5 = new JMenuItem("Green");
        iCol5.addActionListener(this);
        iCol5.setActionCommand("Green");
        menuColour.add(iCol5);

        iCol6 = new JMenuItem("Gray");
        iCol6.addActionListener(this);
        iCol6.setActionCommand("Gray");
        menuColour.add(iCol6);

        iCol7 = new JMenuItem("Orange");
        iCol7.addActionListener(this);
        iCol7.setActionCommand("Orange");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        switch(command){
            ...
            case "Exit"         : fun.exit();
                                    break; 
            case "Word Wrap"    : format.wordWrap(); //A Word Wrap processimg feature that forces all text to be confined within
                                                    //defined margins. When a line of text is filled, the word processor automatically
                                                    //moves the text to the next line ,so the user doesn't have tp press the return key after 
                                                    //every line.
                                    break;
            ...
            case "Times New Roman": format.setFont(command);
                                    break;
            case "Consolas": format.setFont(command);
                                    break;  
            ...
            case "Green"         : col.changeColour(command);
                                    break;
            case "Gray"          : col.changeColour(command);
                                    break;
